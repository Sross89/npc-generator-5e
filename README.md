...
**Choose a specific actor:** switch "Generate By" to *Choose a Specific Actor*, check the box next to any compendium(s) you want to pull from (any Actor compendium you have access to — an official Monster Manual pack you own, a homebrew pack, etc. — you can check more than one at a time), then pick an actor from the combined list (e.g. "Guard"). From there you can:
